...
import { useGetHouseByCodeQuery, useUpdateHouseMutation, useUploadImageMutation } from '../../features/api/apiHousesSlice';
...
export default function HouseFormEdit(){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                position: "top-end",
                icon: "error",
                title: "La casa no pudo ser actualizado, por favor verifique los datos",
                showConfirmButton: false,
                timer: 1500
              })
        }
    ...
    const { data: house, isLoading, isError, error } = useGetHouseByCodeQuery(params.code);
    ...
    return (
        <HouseForm props={{handleSubmit:handleSubmit, handleChangeImage:handleChangeImage, onFileChange: null, house: house}} />
    );
}