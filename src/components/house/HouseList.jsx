        ...
        <table className="table-auto w-full">
            <thead>
                <tr className="bg-slate-500">
                    ...
                    <th className="px-4 py-2 text-white">Rooms</th>
                    <th className="px-4 py-2 text-white">Bathrooms</th>
            ...
            <tbody className="bg-gray-200 ">
                ...
                <tr key={house._id}>
                    ...
                    <td className="border-y-2 px-4 py-2 border-indigo-600">{house.rooms}</td>
                    <td className="border-y-2 px-4 py-2 border-indigo-600">{house.bathrooms}</td>
